...
axiosInstance.interceptors.request.use(
  (config) => {
    ...
    if (token) {
      ...
      // FIXME remove this
      // config.headers.Authorization = "3a43e37517208979a53bb4332085c75d62b584feed49437b3896025e09c03894600a75b3e49726bda0cd389c9808eefc3b5d69e972757c178613f4e524a148b9";
    }
