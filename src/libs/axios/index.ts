...
axiosInstance.interceptors.request.use(
  (config) => {
    ...
    if (token) {
      ...
      // FIXME remove this
      // config.headers.Authorization = "2d116234ecef283f5c4e29716cb0da083a159653e3e06ad9b189c895d50e2e881cb86eb923306773ff9baf23daf89dce1bbe4a7b1f45db98ccd6ea480950f5a6";
    }
