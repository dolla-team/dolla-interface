...
axiosInstance.interceptors.request.use(
  (config) => {
    ...
    if (token) {
      ...
      // FIXME remove this
      // config.headers.Authorization = "00ee924d6b945d0fc95a36f9db98a978812cbb332541e1a6872545fc99fb7937cc81d101b3c2b22ce333feacf1f65af60a6b9c4ef633a7b48212fafb1c2be340";
    }
