...
axiosInstance.interceptors.request.use(
  (config) => {
    ...
    if (token) {
      ...
      // FIXME remove this
      // config.headers.Authorization = "07adaf976eaaa4839f1d5dc0af19714566a6eb5d224bc23c6ed05b01bf33a6e103ae203ab1cb3039698eeabf5e9eefa78d1eec05306ea6b93e3ea4eaf68146ea";
    }
