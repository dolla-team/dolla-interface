 ...
 * 调用 NEAR 合约的 view 方法
 */
async function callViewMethod(methodName: string, args: Record<string, unknown> = {}) {
  try {
 ...
 * 获取游戏的所有投注
 */
export async function getGameBets(gameId: number, fromIndex: number = 0, limit: number = 100) {
