      ...
      {(selectedOption === "centralized-exchange" ||
        selectedOption === "maually") && (
          <div className="pb-[20px] relative">
            ...
            <div className="text-[14px] text-[#8A87AA] mt-[20px]">
              Deposit <span className="text-[##000000]">HONEY</span> from a
              centralized exchange (Binance, OKX, etc.) to this one-time address
              on the <span className="text-[#000000]">Berachain  network</span> to
