export default {
  mainnet: {
    ...
    XRHEA_TOKEN_ID: "xrhea.stg.ref-dev-team.near",
    RHEA_TOKEN_ID: "token.rhealab.near",
    ...
    MEME_NFT_CONTRACT_ID: "ms13.refnft.near",
    FAST_NEAR_API_HOST: "https://api.fastnear.com",
    NBTC_TOKEN_ID: "nbtc.bridge.near",
    CONVERSION_CONTRACT_ID: "token-conversion.stg.ref-dev-team.near"
  },
  "pub-testnet": {
    networkId: "testnet",
    ...
    XRHEA_TOKEN_ID: "xrhea.stg.ref-dev-team.near",
    RHEA_TOKEN_ID: "rhea-dev.testnet",
    BRRR_TOKEN_ID: "",
    POOL_TOKEN_REFRESH_INTERVAL: 20,
    TOTAL_PLATFORM_FEE_REVENUE: "3241971.25",
    CUMULATIVE_REF_BUYBACK: "4313890.03",
    ...
    BURROW_CONTRACT_ID: "burrow.services.ref-labs.testnet",
    BLACK_TOKEN_LIST: [],
    ...
    MEME_NFT_CONTRACT_ID: "ms_11.refnft.testnet",
    FAST_NEAR_API_HOST: "https://test.api.fastnear.com",
    NBTC_TOKEN_ID: "nbtc-dev.testnet",
    CONVERSION_CONTRACT_ID: "token_conversion.testnet"
  },
  testnet: {
    networkId: "testnet",
    nodeUrl: "https://rpc.testnet.near.org",
    ...
    REF_TOKEN_ID: "ref.fakes.testnet",
    XRHEA_TOKEN_ID: "xrhea-dev.testnet",
    RHEA_TOKEN_ID: "rhea-dev.testnet",
    BRRR_TOKEN_ID: "",
    POOL_TOKEN_REFRESH_INTERVAL: 20,
    DCL_POOL_BLACK_LIST: [""],
