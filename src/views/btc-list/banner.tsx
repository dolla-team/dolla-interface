  ...
  return (
    <div className="w-full h-[300px] relative rounded-[20px] bg-[#000]">
      ...
      <div className="absolute left-[16px] bottom-[0px] button group">
        ...
        <div className="absolute left-[102px] bottom-[16px] w-[152px] h-[40px] bg-linear-to-b from-[#37EFA8] to-[#5BF5BA] flex items-center justify-center rounded-[12px] text-[14px] text-[#2B3337] font-[600]">
          Bidder
      ...
      <div className="absolute right-[40px] bottom-[0px] button group">
        ...
        <div className="absolute right-[60px] bottom-[16px] w-[152px] h-[40px] bg-linear-to-b from-[#FFB700] to-[#FFCE54] flex items-center justify-center rounded-[12px] text-[14px] text-[#2B3337] font-[600]">
          Seller
          <div className="w-full h-full rounded-[12px] bg-black/30 absolute left-0 top-0 opacity-100 group-hover:opacity-0 transition-opacity duration-300" />
        </div>
      </div>
