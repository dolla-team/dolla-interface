...
const ClaimModal = (props: any) => {
  ...
  return (
    <Modal open={open} onClose={onClose}>
      ...
      >
        <div className="w-full shrink-0 flex justify-between items-center bg-black/20 rounded-t-[10px] p-[18px_23px_16px_31px] text-white text-[20px] font-[700] leading-[100%]">
