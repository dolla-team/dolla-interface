...
const StatisticsPlayer = (props: any) => {
  ...
  return (
    <div
      className={clsx(
        "flex justify-between items-center gap-[40px] pl-[13px] mt-[20px] pb-[16px] max-md:mt-[13px] max-md:flex-col max-md:gap-[20px] max-md:pl-0 max-md:pb-0",
        className
      )}
    >
      <div className="flex items-center gap-[32px] max-md:w-full">
      ...
      <div className="flex items-center gap-[50px] flex-2 max-md:flex-col max-md:w-full">
        <LabelValue
