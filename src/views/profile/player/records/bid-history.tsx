      ...
      render: (record: any) => {
        ...
        return (
          <div className="flex items-center gap-[10px] whitespace-nowrap">
            ...
            <div className="text-[#FFE9B2] text-[14px] underline cursor-pointer">
              <a href={`${currentChain?.blockExplorers?.default?.url}/tx/${record.tx_hash}?cluster=${import.meta.env.VITE_SOLANA_CLUSTER_NAME}`} target="_blank" rel="noopener noreferrer">Tx</a>
            </div>
