...
export default function ResultPanel({ result, reward, onBackToAnalyze }: any) {
  ...
  const predictions = result.aiPredictions?.sort(
      ...
      <div className="w-[542px] p-[24px] mt-[20px] rounded-[20px] border-[#3E300E] bg-[#3F3F3F99] shadow-[0_2px_6px_0_rgba(0,0,0,0.25)_inset] backdrop-blur-[10px]">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right leading-[120%]">
            ...
            <div className="text-[46px] text-[#00FF84] mt-[16px]">
        ...
        <div className="flex items-center justify-end gap-[14px] mt-[28px] w-full font-[Courier]">
          <button
            onClick={async () => {
        ...
        <div className="flex flex-col gap-[10px]">
          ...
          >
            ...
            <div className="flex items-center gap-[8px]">
              {!followed ? (
                <div className="text-white cursor-pointer" onClick={(ev) => {
                  ev.stopPropagation();
...
const Completed = () => <div className="flex items-center gap-[4px]">
  <svg xmlns="http://www.w3.org/2000/svg" width="17" height="13" viewBox="0 0 17 13" fill="none">
    <path d="M0.712891 5.46356L5.86914 10.7017L15.7129 0.70166" stroke="#54FF59" stroke-width="2" />
  </svg>
