...
import { c } from "near-api-js/lib/transaction-C81hWIM7";
...
export default function Demo() {
  ...
  const { createGame, createGameAddress, getAllGames, resumeGame, pauseGame, cancelGame } = useGameAction({
  ...
  return <div>
    <div>
      accountId: {JSON.stringify(account)}
    </div>
    <div>
