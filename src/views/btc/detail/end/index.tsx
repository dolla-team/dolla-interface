...
export default function EndPanel({ data }: { data: any }) {
  ...
  return (
    data && (
      <div
        className={clsx(
          "border bg-[#FFFFFF1A] backdrop-blur-[10px]",
          isMobile
            ? "w-screen mt-[12px] p-[20px] border-t-[#605D55] rounded-t-[20px]"
            : "w-[815px] h-full overflow-y-auto p-[20px] border-[#605D55] rounded-[20px]"
        )}
      >
        <div
          className={clsx(
