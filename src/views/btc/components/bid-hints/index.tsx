...
export default function BidHints({ taskId }: { taskId: string }) {
  ...
  return (
    (step > 1 || flipStatus > 0) && (
      <div
        key={step}
        className={`absolute top-0 left-1/2 -translate-x-1/2 flex flex-col justify-center items-center w-[516px] h-[72px] rounded-[16px] border border-[#605D55] bg-[#FFFFFF1A] backdrop-blur-[25px] transition-all duration-[400ms] ease-out ${
          isVisible
