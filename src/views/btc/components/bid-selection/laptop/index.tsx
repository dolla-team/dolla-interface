...
import { LuckyInfo } from "@/sections/lucy-draw/detail-modal/panel";
    ...
    <div className="absolute bottom-[-20px] left-0 w-full h-[202px]">
      ...
      <div className="relative z-[10] flex items-center justify-center xl:gap-[100px] xl:scale-none gap-[80px] scale-[0.75]">
        <div className="flex items-center justify-end gap-[500px] mt-[20px]">
          <div className="w-[254px] px-[10px] mt-[70px] h-[60px] flex items-center justify-between">
          ...
          <div className="w-[254px] px-[10px] mt-[70px] h-[60px] flex items-center justify-between">
            <div className="flex items-center gap-[6px]">
              <span className="text-[16px] text-white">Tickets</span>
              <LuckyInfo />
            </div>
        ...
        <AnimatePresence>
          {bids === 1 && (
            <motion.img
              ...
              alt="bid 1"
              className={clsx(
                "w-[282px] h-[239px] absolute bottom-[30px] left-[calc(50%-120px)] xl:scale-none scale-[0.75] pointer-events-none"
              )}
              {...animate}
            />
          )}
          {bids === 10 && (
            <motion.img
              ...
              alt="bid 10"
              className={clsx(
                "w-[331px] h-[194px] absolute bottom-[40px] left-[calc(50%-150px)] xl:scale-none scale-[0.75] pointer-events-none"
              )}
              {...animate}
            />
          )}
          {bids === 50 && (
            <motion.img
              ...
              alt="bid 50"
              className={clsx(
                "w-[272px] h-[225px] absolute bottom-[40px] left-[calc(50%-120px)] xl:scale-none scale-[0.75] pointer-events-none"
              )}
              {...animate}
            />
          )}
          {bids === 100 && (
            <motion.img
              ...
              alt="bid 100"
              className={clsx(
                "w-[289px] h-[198px] absolute bottom-[50px] left-[calc(50%-130px)] xl:scale-none scale-[0.75] pointer-events-none"
              )}
              {...animate}
            />
          )}
