...
export default function CashierEntry({
  ...
  return (
    <div
      onClick={onClick}
      className="absolute bottom-[10px] left-[50%] translate-x-[-50%] flex items-center gap-1 cursor-pointer"
    >
      <svg
        width="19"
        height="16"
      ...
      <div className="text-[#FFE9B2] text-[16px] font-[BlackHanSans]">
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <circle cx="12.1436" cy="12" r="12" fill="#FFEA00" />
        <path
