        ...
        >
            ...
            >
                {items.map((item, index) => (
                    ...
                    >
                        <span className="text-[20px] text-black px-2 py-1 rounded" style={{ WebkitTextStroke: '1px white', color: 'black' }}>
                            {item.address} Won
                        </span>
                        <span className={clsx("text-lg font-bold drop-shadow-lg", item.color)}>
                            {item.multiplier}
                        </span>
