...
class WebSocketService {
  ...
  private reconnectMessage: SubscribeMessage | null = null
        ...
        this.ws.onmessage = event => {
          try {
            ...
            if (data.stream && data.data !== undefined) {
              ...
              console.log('Message without stream field, checking all handlers')
  ...
  private attemptReconnect(): void {
    ...
    this.reconnectTimer = setTimeout(() => {
      ...
      if (this.reconnectMessage) {
        this.subscribe(this.reconnectMessage.params, this.reconnectMessage.id)
      }
      this.connect().catch(error => {
